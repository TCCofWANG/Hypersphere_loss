...
if __name__ == "__main__":
    frcnn = FRCNN(model_path = '/home/ubuntu/public2/cjp/OD/faster-rcnn-HL/logs/last_epoch_weights_seed11.pth')
    #----------------------------------------------------------------------------------------------------------#
    #   mode用于指定测试的模式：
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/home/ubuntu/public2/cjp/OD/VOCdevkit/VOC2007/Test_images/"
